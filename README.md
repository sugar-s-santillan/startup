...
- **Service** - I will use AWS to host and Node.js as a backend service layer that will provide server functionality. It will handle retrieving and sending data through API's. The backend will provide endopoints for obtaining lead information. 
